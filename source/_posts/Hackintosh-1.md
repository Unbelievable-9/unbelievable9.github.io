...
- **UniBeast** 是用来制作 U盘 安装镜像的全自动化工具
- **MultiBeast** 是在安装完成后 用来完善相关相关配置的工具

首先对于这个论坛而言 我近期的所有 Hackintosh 新闻 基本都是从这里获取的 
但是这个是一个纯英文的论坛 对于国人而言 不是太友好 我想英文基础不错的玩家 都应该去这里注册一个账号
随时关注 Hackintosh 世界的新闻

当然对于各种制作方式的争论 一直都没有停过 
有的人更喜欢 一步一步自己制作安装镜像
有人的更推崇 **UniBeast** 这样的自动化工具 
在我看来 根据 **最有效的** 原则 使用这个工具是最好的 因为的确可以避免很多麻烦 让我们把精力放在完善上
